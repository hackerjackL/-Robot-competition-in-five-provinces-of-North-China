...
>>>>>>> 1a39849 (Add configurable area filtering and area test tools - Add 2024 and 2025 line following with configurable area filtering - Implement min_area and max_area configuration - Unify area filtering logic - Add area test detection and statistics scripts - Update README with detailed documentation)
